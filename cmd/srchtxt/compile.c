...
#if (defined(__sun))||(!defined(__svr4__)) /* Where this is actually needed. */
...
#ifndef _REG_BACKREF_MAX
#define	_REG_BACKREF_MAX 9		/* Max # of subexp. backreference */
#endif /* _REG_BACKREF_MAX */

/*
 * pseudo compile/step/advance global variables
 */
int nbra;
char *locs; 		/* for stopping execess recursion */
char *loc1;  		/* 1st character which matched RE */
char *loc2; 		/* char after lst char in matched RE */
char *braslist[]; 	/* start of nbra subexp  */
char *braelist[]; 	/* end of nbra subexp    */
int regerrno;
int reglength;
...
#endif /* (defined(__sun))||(!defined(__svr4__)) */
