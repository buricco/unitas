...
/*	from OpenSolaris "devreserv.c	1.9	05/06/08 SMI"	*/

/*
 * Portions Copyright (c) 2007 Gunnar Ritter, Freiburg i. Br., Germany
 *
 * Sccsid @(#)devreserv.c	1.3 (gritter) 2/25/07
 */
/*LINTLIBRARY*/
...
{
	/* Automatics */
	struct devlks  *alloc = NULL;	/* Ptr to alloc'ed space */
...
{
	/* Automatics */
	struct reservdev	**rtnlist = NULL;	/* Ptr to return list */
